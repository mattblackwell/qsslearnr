...
- Exercises attempted: `r sum(params$output$checked)` 
- Exercises completed correctly: `r sum(params$output$correct, na.rm = TRUE)`
...
knitr::kable(params$output, "latex", booktabs = TRUE)
```
